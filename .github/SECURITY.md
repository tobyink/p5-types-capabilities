# Types-Capabilities Security Policy

The [latest stable release on CPAN](https://metacpan.org/release/Types-Capabilities)
...
[the Changes file on CPAN](https://metacpan.org/changes/distribution/Types-Capabilities)
with security-related changes tagged "SECURITY" in capital letters.

## Reporting a Vulnerability

Please report any issues via [GitHub Issues](https://github.com/tobyink/p5-types-capabilities/issues).
